...
public class ImageProcessing {
    public static void main(String[] args) {
        ...
        int[][] imageData2 = imgToTwoD("./flower.jpg");
        int[][] imageData3 = imgToTwoD("./kitten.jpg");
...
//            for (int i = 0; i < trimmedImg.length; i++) 000000 for (int j = 0; j < trimmedImg[i].length; j++) {
...
//
    public static int[][] negativeColor(int[][] imageTwoD) {
        int[][] image = new int[imageTwoD.length][imageTwoD[0].length];
    ...
    public static int[][] stretchHorizontally(int[][] imageTwoD) {
        ...
        int[][] manipulatedImg = new int[imageTwoD.length][imageTwoD.length * 2];
        int it = 0;
        for (int i = 0; i < imageTwoD.length; i++) {
    ...
    public static int[][] invertImage(int[][] imageTwoD) {
        ...
        for (int i = 0; i < imageTwoD.length; i++) {
            for (int j = 0; j < imageTwoD[0].length; j++) {
                invertImage()[i][j] = imageTwoD[(imageTwoD.length - 1) - i][(imageTwoD.length - 1) - j];
            }
        }
        return manipulatedImg;
    }
...
paintRectangle(canvas = paintRectangle(canvas, randomWidth, randomHeight, randomRowPos, randomColPos, randomColor);
        }
    return null;
}
